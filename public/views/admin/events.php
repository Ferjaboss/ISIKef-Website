...
<h2 class="col-span-3 mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 pt-4">Events</h2>
  ...
  <i class="fa-solid fa-plus"></i>  Nouveau Evenement
</a>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 ">Ajouter Un Evenement</h3>
                <form class="space-y-6" action="" method="post">
                    <div>
                        <label for="titre" class="block mb-2 text-sm font-medium text-gray-900 ">Titre :</label>
                        <input type="text" name="titre" id="titre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="Titre">
                    </div>
                    <div>
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 ">description :</label>
                        <textarea name="description" id="description" placeholder="Type Whatever On your mind" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required></textarea>
                    </div>
                    <div>
                        <label for="date" class="block mb-2 text-sm font-medium text-gray-900 ">Date :</label>
                        <input type="date" name="date" id="date" class="mb-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="Titre" required>
                ...
                if(isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO events (title, description, release_date) VALUES ('$titre', '$description', '$date')";
    ...
    ?>
            <tr class="bg-white border-b ">
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" name="delete_image" class="font-medium text-red-600 hover:underline" onclick="return confirm('Are you sure you want to delete this event?')"><i class="fa-sharp fa-solid fa-trash"></i>Supprimer</button>
                </form>
    </td>
</tr>
<?php
...
if (isset($_POST['delete_image'])) {
    ...
    $sql = "DELETE FROM events WHERE id = '$image_id'";
